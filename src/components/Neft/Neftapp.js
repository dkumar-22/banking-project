            ...
            <div className="space-y-12">
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <p className="mt-1 text-sm leading-6 text-gray-600 sm:col-span-12">
                            Please Note : .
                        </p>
                        <p className="mt-1 text-sm leading-6 text-gray-600 sm:col-span-12">
                            1.Transaction will be executed in the next working
                            day If they are scheduled for sundays,National
                            holidays.
                            <br />
                            2.Timing for NEFT Monday-Saturday(Except 2nd and 4th
